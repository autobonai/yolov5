...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Freeze TODO: currently it's just empty
...
if __name__ == '__main__':
    ...
    parser.add_argument('--one-channel-extractor', type=str, default="extract_gray", help='how to extract the single channel image')  # noqa
    ...
    # Evolve hyperparameters (optional)
        ...
        for _ in range(NUM_GENERATIONS):  # generations to evolve
